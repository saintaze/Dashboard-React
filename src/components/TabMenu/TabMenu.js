    ...
    <div className="TabMenu">
      <div className="TabMenu__links">
        <a 
          ...
          className={cx('TabMenu__link', { 'TabMenu__link--active': tabChoice === TAB_CHOICES.ACCOUNT})}
          >
          Account Settings
        </a>
        <a 
          onClick={() => setTabChoice(TAB_CHOICES.USER)} 
          className={cx('TabMenu__link', { 'TabMenu__link--active': tabChoice === TAB_CHOICES.USER })}
          >
          User Information
        </a>
      </div>
